...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-1.5 rounded-md py-2 pr-8 pl-2.5 text-sm outline-hidden select-none transition-colors",
        "text-[#e8eaff] hover:bg-[#313766] hover:text-white",
        "focus:bg-[#313766] focus:text-white",
        "data-[highlighted]:bg-[#313766] data-[highlighted]:text-white",
